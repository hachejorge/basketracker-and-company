		...
		<div class="recuadro">
		    <div class="navbar">
		        <div class="navbar-item">
		        	<img src="https://img.icons8.com/?size=100&id=131&format=png&color=000000" alt="Buscar" onClick="window.location.href='<%= request.getContextPath() %>/views/jsp/inicio.jsp'">
		        ...
		        <div class="navbar-item active">
		            <img src="https://img.icons8.com/?size=100&id=87193&format=png&color=FFFFFF" alt="Mensajes" onClick="window.location.href='<%= request.getContextPath() %>/views/jsp/mensajes.jsp'">
		            <span>Mensajes</span>
		        </div>
		    </div>	    
		</div> 
